...
class Subscriptionandpaymentplans extends StatefulWidget {
  final Map<String, dynamic> planDetails;

  const Subscriptionandpaymentplans({
    Key? key,
    required this.planDetails
  }) : super(key: key);

  @override
  State<Subscriptionandpaymentplans> createState() => _SubscriptionandpaymentplansState();
}

class _SubscriptionandpaymentplansState extends State<Subscriptionandpaymentplans> {
  ...
  // Keep the existing _getStartedButton method
